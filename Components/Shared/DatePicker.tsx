                        ...
                        ? (
                            <div className="flexCenter max-md:flex-col max-md:p-2">
                                <label className="flexCenter">
                                    <span className="bg-white absolute p-2 rounded-xl text-black font-bold text-center my-2 p-1 w-[200px] hidden max-md:block">Start Time</span>
                                    <input type="time" className="border-none outline-none cursor-pointer bg-white p-2 m-2 rounded-xl" name='startTime' />
                                </label>
                                <label className="flexCenter">
                                    <span className="bg-white absolute p-2 rounded-xl text-black font-bold text-center my-2 p-1 w-[200px] hidden max-md:block">Start Date</span>
                ...
                <span className="font-bold text-white">Ends At</span>
                {
                    Picker.PickerType === "create"
                        ? (
                            <div className="flexCenter max-md:flex-col max-md:p-2">
                                <label className="flexCenter">
                                    <span className="bg-white absolute p-2 rounded-xl text-black font-bold text-center my-2 p-1 w-[200px] hidden max-md:block">End Time</span>
                                    <input type="time" className="border-none outline-none cursor-pointer bg-white p-2 m-2 rounded-xl" name='endTime' />
                                </label>
                                <label className="flexCenter">
                                    <span className="bg-white absolute p-2 rounded-xl text-black font-bold text-center my-2 p-1 w-[200px] hidden max-md:block">End Date</span>
