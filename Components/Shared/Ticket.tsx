    ...
    return (
        <div className='rounded-xl border-b shadow flex flex-col m-10 w-fit'>
            <div className='flexCenter bg-black rounded-t-xl'>
                ...
                <p className='text-white text-center absolute w-[300px] max-md:w-[200px] font-bold'>{event.title}</p>
            </div>
            <div className='flexAround'>
                <div className='p-2 px-2 w-fit text-center m-2 font-bold rounded-3xl text-green-800 bg-green-300 flexCenter'>{event.price}</div>
